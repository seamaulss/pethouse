            ...
            <div class="flex items-center">
                <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3 group">
                    ...
                    <div class="flex flex-col">
                        <span class="font-bold text-lg lg:text-xl leading-tight">LARAPetHouse</span>
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-full overflow-hidden border-2 border-white shadow-sm flex-shrink-0">
                            ...
                            @endphp
                            @if($user->foto_url)
                            <img src="{{ asset('storage/foto_user/' . $user->foto) }}" alt="Foto Profil" class="w-full h-full object-cover">
                            @else
